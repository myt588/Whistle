...
//-------------------------------------------------------------------------------------------------------------------------------------------------
#define     FIREBASE                            @"https://crackling-heat-8555.firebaseio.com/"
...
#define		PF_USER_FULLNAME					@"nickname"             //	String
#define		PF_USER_FULLNAME_LOWER				@"nickname_lower"		//	String
#define		PF_USER_TWITTERID					@"twitterId"			//	String
#define		PF_USER_FACEBOOKID					@"facebookId"			//	String
#define		PF_USER_PICTURE						@"portrait"				//	File
...
#define     PF_MESSAGE_LOCATION                 @"location"             //  CLLocation
...
#define     PF_RECENT_USERID                    @"userId"               //  String
...
#define     PF_RECENT_DATE                      @"date"                 //  Date
#define     PF_RECENT_PROFILEID                 @"profileId"            //  String
#define     PF_RECENT_ID                        @"recentId"             //  String
//-----------------------------------------------------------------------

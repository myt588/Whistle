...
- (void)getPhotos:(OLFacebookPhotosForAlbumRequestHandler)handler {
    if ([FBSDKAccessToken currentAccessToken]) {
        ...
        [request startWithCompletionHandler:^(FBSDKGraphRequestConnection *connection, id result, NSError *error) {
            ...
            NSError *parsingError = [NSError errorWithDomain:@"I'm a domain" code:99 userInfo:@{NSLocalizedDescriptionKey: parsingErrorMessage}];
        ...
        handler(nil, [NSError errorWithDomain:@"I'm a domain" code:100 userInfo:@{NSLocalizedDescriptionKey: message}], nil);
    }
}

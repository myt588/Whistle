...
class WESlideTransition: NSObject, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate{
    ...
    func presentNavigation(transitionContext: UIViewControllerContextTransitioning) {
        ...
        var offSetTransform = CGAffineTransformMakeTranslation(-size.width + 280, 0)
